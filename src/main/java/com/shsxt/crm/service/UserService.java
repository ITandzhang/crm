...
public class UserService extends BaseService<User,Integer>{
    ...
    public void updateUserPassword(Integer userId,String oldPassword,String newPassword,String confimePassword){

        checkParams(userId,oldPassword,newPassword,confimePassword);
